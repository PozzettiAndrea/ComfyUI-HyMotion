...
from .nodes_preview import NODE_CLASS_MAPPINGS as NODE_CLASS_MAPPINGS_PREVIEW, NODE_DISPLAY_NAME_MAPPINGS as NODE_DISPLAY_NAME_MAPPINGS_PREVIEW
...
NODE_CLASS_MAPPINGS = {**NODE_CLASS_MAPPINGS_MODULAR, **NODE_CLASS_MAPPINGS_PREVIEW, **NODE_CLASS_MAPPINGS_3D}
NODE_DISPLAY_NAME_MAPPINGS = {**NODE_DISPLAY_NAME_MAPPINGS_MODULAR, **NODE_DISPLAY_NAME_MAPPINGS_PREVIEW, **NODE_DISPLAY_NAME_MAPPINGS_3D}
